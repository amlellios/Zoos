...
namespace Pisces_Game
{
    public partial class Round2 : Form
    {
        ...
        public static int privatePlayerPond;    //Can be summoned later
        ...
        private void showZodiacLbl_Click(object sender, EventArgs e)
        {

        }

        private void catchPromptLbl_Click(object sender, EventArgs e)
        {
        ...
        private void catchFishBox_ValueChanged(object sender, EventArgs e)
        {

        }

        private void fishCaughtLbl_Click(object sender, EventArgs e)
        {

        }

        private void eatPromptLbl_Click(object sender, EventArgs e)
        {

        }

        private void eatFishBox_ValueChanged(object sender, EventArgs e)
        {

        }

        private void eatFishLbl_Click(object sender, EventArgs e)
        {

        }

        private void investPromptLbl_Click(object sender, EventArgs e)
        {

        }

        private void investBox_ValueChanged(object sender, EventArgs e)
        {

        }

        private void investFishLbl_Click(object sender, EventArgs e)
        {
